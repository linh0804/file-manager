...
if ($dir == null || $name == null || !is_dir(process_directory($dir . '/' . $name))) {
    ...
    if (isset($_POST['submit'])) {
        ...
        } else if (!copydir($dir . '/' . $name, process_directory($_POST['path']))) {
    ...
    echo '<div class="list">
                ...
                <form action="' . action_link('folder_copy', ['dir' => $dir, 'name' => $name] + get_page_list_params()) . '" method="post">
